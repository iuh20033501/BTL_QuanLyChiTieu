...
import TEST from './Screens/test';
  ...
  export default function App() {
    ...
    return (
      ...
      //     <stack.Screen name= 'Menu1' component={Menu1}  options={{ headerShown: false }}></stack.Screen>
      //     <stack.Screen name= 'Datepicker' component={Datepicker}  options={{ headerShown: false }}></stack.Screen>
      ...
      //     <stack.Screen name= 'SuaTN' component={Sua}  options={{ headerShown: false }}></stack.Screen>
      //     <stack.Screen name= 'SuaCT' component={Sua2}  options={{ headerShown: false }}></stack.Screen>
